...
function CommunityScreen() {
    return (
      <View style={{ flex: 1,...StyleSheet.absoluteFill,justifyContent:'flex-start',alignItems:'center'}}>
        ...
        <TouchableOpacity onPress={()=>{Linking.openURL('mailto:XXXXXXXXXXXX?subject=&body=');}} style={styles.appButtonContainer1}>
        ...
        <TouchableOpacity onPress={()=>{Linking.openURL('https://XXXXXXXXXXX');}} style={styles.appButtonContainer2}>
